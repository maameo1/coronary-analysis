...
MODELS = [
    ("L1 (vesselness)",           r"$\mathcal{L}_v$ (L1)",    "#607D8B", "--", "o"),
    ("EXP-044 (frozen, w=0.03)",  "Frozen ($w$=0.03)", "#2196F3", "-",  "s"),
    ("EXP-048 (frozen, w=0.05)",  "Frozen ($w$=0.05)", "#1565C0", "-",  "D"),
    ("EXP-047 (partial, w=0.05)", "Partial ($w$=0.05)","#FF9800", "-",  "^"),
    ("EXP-045 (full, w=0.10)",    "Full ($w$=0.10)",   "#F44336", "-",  "v"),
]
